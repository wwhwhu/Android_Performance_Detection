...
if __name__ == '__main__':
    ...
    y = int(input("当前采集的环境属于哪一类，请输入数字：1：固定前台应用淘宝，2.固定前台应用抖音，3.固定前台应用原神，4.无固定前台应用\n"))
    ...
    os.system("adb pull data/data/com.wwh.updatemonitor/files/result.csv " + s + "\\" + x1[int(y)] + "\\" + x2[int(z)] + "\\normal")
    os.system("cd " + s + "\\" + x1[int(y)] + "\\" + x2[int(z)] + "\\normal && rename result.csv Normal.csv")