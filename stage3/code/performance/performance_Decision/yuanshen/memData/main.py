...
def decsionTreeSolution(feature):
    ...
    joblib.dump(clf, filename='res/memDecisionTreeClassifier.pkl')
    # 预测结果与真实结果的对比
    ...
    a = tree.plot_tree(clf,
                       ...
                       class_names=['Normal', 'MemAbnormal'],
                       rounded=True,
                       filled=True,
                       fontsize=14)
    # plt.show()
    ...
    sklearn2pmml(pipeline, 'res/memDecisionTreeClassifier.pmml', with_repr=True)
